const TermsOfUse = () => (
  <div className="container">
    <div className="whiteContainer">
      ...
      <p className="date">Last updated March 11, 2020</p>

      <p className="title">AGREEMENT TO TERMS</p>
      <p className="paragraph">
        These Terms of Use constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity (“you”) and Rate The
        Refs, LLC ("<b>Company</b>", “<b>we</b>”, “<b>us</b>”, or “<b>our</b>”),
        concerning your access to and use of the www.ratetherefs.com website as
      ...
      <p className="title">USER REPRESENTATIONS</p>
      <p className="paragraph">
      ...
      <p className="title">PROHIBITED ACTIVITIES</p>
      <p className="paragraph">
      ...
      <p className="paragraph">As a user of the Site, you agree not to:</p>
      ...
      <p className="title">USER GENERATED CONTRIBUTIONS </p>
      <p className="paragraph">
      ...
      <ol className="orderedList">
        ...
        <li className="orderedListItem">
          ...
          every identifiable inpidual person in your Contributions to use the
          name or likeness of each and every such identifiable inpidual person
      ...
      <p className="title">CONTRIBUTION LICENSE</p>
      <p className="paragraph">
      ...
      <p className="title">GUIDELINES FOR REVIEWS</p>
      <p className="paragraph">
      ...
      <p className="title">MOBILE APPLICATION LICENSE</p>
      <p className="subTitle">Use License</p>
      <p className="paragraph">
      ...
      <p className="subTitle">Apple and Android Devices</p>
      <p className="paragraph">
      ...
      <p className="title">THIRD-PARTY WEBSITE AND CONTENT</p>
      <p className="paragraph">
      ...
      <p className="title">ADVERTISERS</p>
      <p className="paragraph">
      ...
      <p className="title">SITE MANAGEMENT</p>
      <p className="paragraph">
      ...
      <p className="paragraph">
        ...
        Policy: www.ratetherefs.com/privacy. By using the Site, you agree to be
      ...
      <p className="title">COPYRIGHT INFRINGEMENTS</p>
      <p className="paragraph">
      ...
      <p className="title">TERM AND TERMINATION</p>
      <p className="paragraph">
      ...
      <p className="title">MODIFICATIONS AND INTERRUPTIONS</p>
      <p className="paragraph">
      ...
      <p className="subTitle">Informal Negotiations</p>
      <p className="paragraph">
        ...
        collectively, the “Disputes”) brought by either you or us (inpidually, a
      ...
      <p className="subTitle">Binding Arbitration</p>
      <p className="paragraph">
        ...
        arbitration will take place in Iron, Utah. Except as otherwise provided
      ...
      <p className="paragraph">
        ...
        courts located in Iron, Utah, and the Parties hereby consent to, and
      ...
      <p className="subTitle">Restrictions</p>
      <p className="paragraph">
        The Parties agree that any arbitration shall be limited to the Dispute
        between the Parties inpidually. To the full extent permitted by law, (a)
        no arbitration shall be joined with any other proceeding; (b) there is
      ...
      <p className="title">LIMITATIONS OF LIABILITY</p>
      <p className="paragraph">
        ...
        YOU TO US DURING THE __________ MONTH PERIOD PRIOR TO ANY CAUSE OF
      ...
      <p className="title">CALIFORNIA USERS AND RESIDENTS</p>
      <p className="paragraph">
        If any complaint with us is not satisfactorily resolved, you can contact
        the Complaint Assistance Unit of the pision of Consumer Services of the
      ...
      <p className="paragraph">
        <b>Rate The Refs, LLC</b>
      </p>
      <p className="paragraph">
        <b>521 S 515 W</b>
      </p>
      <p className="paragraph">
        <b>Cedar City, UT 84720</b>
      </p>
      <p className="paragraph">
        <b>United States</b>
      </p>
      <p className="paragraph">
        <b>Phone: 801-913-7245</b>
      </p>
      <p className="paragraph">
        <b>
          <a href="mailto:info@ratetherefs.com">info@ratetherefs.com</a>
        </b>
      </p>
      <br />
      <br />
