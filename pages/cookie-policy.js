const CookiePolicy = () => (
  <div className="container">
    <div className="whiteContainer">
      <h1 className="headline">Cookie Policy</h1>
      <p className="date">Last updated March 12, 2020</p>

      <p className="paragraph">
        This Cookie Policy explains how Rate The Refs, LLC ("<b>Company</b>", "
        <b>we</b>", "<b>us</b>", and "<b>our</b>") uses cookies and similar
        technologies to recognize you when you visit our websites at{" "}
        <a href="https://www.ratetherefs.com" target="_blank">
      ...
      <p className="subTitle">What are cookies?</p>
      ...
      <p className="paragraph">
        Cookies set by the website owner (in this case, Rate The Refs, LLC) are
      ...
      <p className="subTitle">Why do we use cookies?</p>
      <p className="paragraph">
      ...
      <p className="subTitle">How can I control cookies?</p>
      ...
      <table className="cookieWrapper">
        <tr className="paragraph">
          <td className="tLeft">Name:</td>
          <td className="tRight">__cfduid</td>
        </tr>
        <tr className="paragraph">
          <td className="tLeft">Purpose:</td>
          <td className="tRight">
            Used by Cloudflare to identify inpidual clients behind a shared IP
            address, and apply security settings on a per-client basis. This is
            a HTTP type cookie that expires after 1 year.
          </td>
        </tr>
        <tr className="paragraph">
          <td className="tLeft">Provider:</td>
          <td className="tRight">.ratetherefs.com</td>
        </tr>
        <tr className="paragraph">
          <td className="tLeft">Service:</td>
          <td className="tRight">
            CloudFlare{" "}
        ...
        <tr className="paragraph">
          <td className="tLeft">Country:</td>
          <td className="tRight">United States</td>
        </tr>
        <tr className="paragraph">
          <td className="tLeft">Type:</td>
          <td className="tRight">http_cookie</td>
        </tr>
        <tr className="paragraph">
          <td className="tLeft">Expires in:</td>
          <td className="tRight">1 month</td>
        </tr>
      </table>
      ...
      <p className="subTitle">Do you serve targeted advertising?</p>
      <p className="paragraph">
      ...
      <p className="subTitle">How often will you update this Cookie Policy?</p>
      <p className="paragraph">
      ...
      <p className="subTitle">Where can I get further information?</p>
      <p className="paragraph">
        If you have any questions about our use of cookies or other
        technologies, please email us at info@ratetherefs.com or by post to:
      </p>
      <p className="paragraph">Rate The Refs, LLC</p>
      <p className="paragraph">521 S 515 W</p>
      <p className="paragraph">Cedar City, UT 84720</p>
      <p className="paragraph">United States</p>
      <p className="paragraph">Phone: 801-913-7245</p>
    </div>
